...
$string .= "\n\t\t    <td style=\"text-align:center\" width=\"200px\">"
        ...
        . "\n\t\t\techo ' | '; "
        . "\n\t\t\techo anchor(site_url('".$c_url."/delete/'),'<i class=\"mdi mdi-delete\"></i>',array('class'=>'delete btn-floating btn-small waves-effect waves-light red lighten-1', 'data-id'=> $".$c_url."->".$pk.",'onclick'=>'javasciprt: return confirm(\'Are You Sure ?\')')); "
        . "\n\t\t\t?>"
        . "\n\t\t    </td>";
